...
//generar token 
Route::post('/generarToken', [AuthController::class, 'generarToken']);
Route::get('/showtoken', [AuthController::class, 'generarToken']);

//generar vista para categorias y vehiculos
Route::get('/categoria-vehiculo', [CategoriesController::class, 'generarCategoriasVehiculos']);
