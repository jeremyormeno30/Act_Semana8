...
class CategoriesController extends Controller
{
    ...
    public function generarCategoriasVehiculos() {
        $categories = Category::with('vehicles')->get();
        $convertidorJson = json_encode($categories, JSON_PRETTY_PRINT);
        return view('categoria_vehiculo', ['convertidorJson' => $convertidorJson]);
    }
}
